...
class ArmEnv(object):
    ...
    def reset(self):
        ...
        # state
        s = np.concatenate((a1xy_ / 200, finger / 200, dist1 + dist2, [1. if self.on_goal else 0.]))
        # self.goal['x'] = random.randint(50, 350)
        # self.goal['y'] = random.randint(50, 350)
        return s
...
class Viewer(pyglet.window.Window):
    ...
    def _update_arm(self):
        ...
        # self.goal.vertices = [self.goal_info['x'] - self.goal_info['l'] / 2, self.goal_info['y'] - self.goal_info['l'] / 2,  # location
