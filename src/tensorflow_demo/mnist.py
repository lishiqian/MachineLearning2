...
xs = tf.placeholder(tf.float32, [None, 784])  # [样本数量， 格式]
ys = tf.placeholder(tf.float32, [None, 10])

# l1 = add_layer(xs, 784, 30, activation_func=tf.nn.softmax)
# prediction = add_layer(l1, 30, 10, activation_func=tf.nn.softmax)
